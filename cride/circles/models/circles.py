...
class Circle(CRideModel):
    ...
    A circle is a private group where rides are offered and taken by its members. To join a circle a user
    must recieve an unique invitation code from an existing circle member.
    """
